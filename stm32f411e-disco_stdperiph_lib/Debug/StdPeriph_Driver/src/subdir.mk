...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo %cd%
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DSTM32F411VETx -DSTM32F4 -DSTM32 -DSTM32F411E_DISCO -DUSE_STDPERIPH_DRIVER -DSTM32F411xE -I"E:/Final Project/stm32f411e-disco_stdperiph_lib/CMSIS/core" -I"E:/Final Project/stm32f411e-disco_stdperiph_lib/CMSIS/device" -I"E:/Final Project/stm32f411e-disco_stdperiph_lib/StdPeriph_Driver/inc" -O0 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
