 ...
 *	This file was created to deal with the JSON communications, so it sets up strings for sending
 *	or decodes them to test the response for success. These functions are called in the main state machine.
 *      Author: Shane Smith
 */
#include <string.h>
#include "jansson.h"
